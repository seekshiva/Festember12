(function(window,document,$,undefined){
	...
	var element = {
	    ...
	    workshop_child : [document.getElementById("element_workshop"),document.getElementById("element_workshop_1"),document.getElementById("element_workshop_2")],
	    house_child : [],
            events_prop : {
	...
	var contents = {
	    ...
	    gaming: "It is a known fact , that in our amazing generation, computers,gadgets and gaming play a pivotal role. So, obviously even a cultural festival like Festember would not be complete without the Network Games. That is what all the couch potatoes, and self declared geeks and gamers thrive on.LAN games, like DOTA, CS, FIFA and NFS are going to be quite the rage thisFestember, with an already estimated huge participation."
	};
	...
	*/
	...
	var position_elements = function(e){
	    ...
	    element["sponsor"].style.width = ((6/100)*w)+'px';
	    element["sponsor"].style.height = ((14/100)*w)+'px';
	    element["sponsor"].style.left = ((19/100)*w)+'px';
	    element["sponsor"].style.bottom = ((6/100)*w)+'px';				
	    ...
	    element["workshop"].style.width = ((14/100)*w)+'px';
	    element["workshop"].style.height = ((7/100)*w)+'px';
	...
	$("#cloud-holder").clouds({
		...
		{src:'Flight2.gif',x:1050,y:553,speedX:-2.5,nature: "flight"},
